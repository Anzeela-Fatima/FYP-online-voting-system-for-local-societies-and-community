...
<body class="crm_body_bg">
    ...
    <nav class="sidebar vertical-scroll dark_sidebar  ps-container ps-theme-default ps-active-y">
        ...
        <ul id="sidebar_menu">
            ...
            <li class>
                <a href="total_user.html" aria-expanded="false">
                    <div class="icon_menu">
            ...
            <li class>
                <a href="total_vote.html" aria-expanded="false">
                    <div class="icon_menu">
            ...
            <li class>
                <a href="total_complains.html" aria-expanded="false">
                    <div class="icon_menu">
            ...
            <li>
                <a href="resister.html" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/8.svg" alt>
                    </div>
