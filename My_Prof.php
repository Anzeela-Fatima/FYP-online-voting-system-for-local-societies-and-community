      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" id="flatNumber" class="form-control" value="A-1" readonly>
          </div>
        </div>
        <div class="col-md-6">
          <img src="candidate_images/handsome-corporate-man-real-estate-agent-assistant-smiling-hold-hands-together-how-may-i-help-you-smiling-friendly-polite-assist-customer-white-background.jpg" alt="Profile Picture" class="img-fluid">
        </div>
      </div>
